...
describe("conversion", () => {
  it("childToParent", () => {
    ...
    id1->I.convertChildToParent->I.ParentId.toString |> Assert.equal("child");
  });

  it("parentToChild", () => {
    let id1 = I.ParentId.create("parent");
    id1->I.convertParentToChild->I.ChildId.toString |> Assert.equal("parent");
  });
  ...
  it("childToFocus", () => {
    let id1 = I.ChildId.create("child");
    id1->I.convertChildToFocus->I.FocusId.toString |> Assert.equal("child");
  });

  it("parentToFocus", () => {
    let id1 = I.ParentId.create("parent");
    id1->I.convertParentToFocus->I.FocusId.toString |> Assert.equal("parent");
  });
