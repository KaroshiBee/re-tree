...
def PyJs_LONG_84_(var=var):
    ...
    def PyJs_anonymous_0_(require, module, exports, this, arguments, var=var):
        ...
        var.registers(['forEachU', 'make', 'mapWithIndex', 'reverseInPlace', 'module', 'getBy', 'getIndexByU', 'reduceWithIndex', 'every2', 'shuffleInPlace', 'everyU', 'some2', 'slice', 'makeBy', 'some', 'Js_math', 'keepU', 'Caml_option', 'makeByAndShuffle', 'mapU', 'keepMapU', 'eqU', 'unzip', 'makeByU', 'forEachWithIndexU', 'reduceReverse2U', 'every', 'keepWithIndexU', 'reduceReverseU', 'sliceToEnd', 'concatMany', 'everyAux2', 'cmp', 'swapUnsafe', 'shuffle', 'mapWithIndexU', 'exports', 'forEach', 'blit', 'set', 'reverse', 'map', 'Caml_primitive', 'keepMap', 'reduce', 'keep', 'concat', 'get', 'reduceWithIndexU', 'cmpU', 'rangeBy', 'zipBy', 'reduceReverse2', 'zipByU', 'keepWithIndex', 'makeByAndShuffleU', 'fill', 'forEachWithIndex', 'reduceU', 'blitUnsafe', 'getByU', 'every2U', 'setExn', 'some2U', 'require', 'reduceReverse', 'partition', 'getIndexBy', 'zip', 'Curry', 'range', 'someU', 'partitionU', 'eq', 'getExn'])
        @Js
        ...
        def PyJsHoisted_shuffleInPlace_(xs, this, arguments, var=var):
            ...
            var.registers(['i_finish', 'i', 'xs', 'len'])
        ...
        def PyJsHoisted_reverseInPlace_(xs, this, arguments, var=var):
            var = Scope({'xs':xs, 'this':this, 'arguments':arguments}, var)
            var.registers(['xs$1', 'i_finish', 'len$1', 'ofs', 'i', 'len', 'xs'])
            var.put('len', var.get('xs').get('length'))
        ...
        def PyJsHoisted_reverse_(xs, this, arguments, var=var):
            var = Scope({'xs':xs, 'this':this, 'arguments':arguments}, var)
            var.registers(['result', 'i_finish', 'i', 'len', 'xs'])
            var.put('len', var.get('xs').get('length'))
        ...
        def PyJsHoisted_make_(l, f, this, arguments, var=var):
            ...
            var.registers(['i_finish', 'i', 'f', 'res', 'l'])
            if (var.get('l')<=Js(0.0)):
                return Js([])
            else:
        ...
        def PyJsHoisted_range_(start, finish, this, arguments, var=var):
            ...
            var.registers(['cut', 'start', 'i', 'finish', 'arr'])
        ...
        def PyJsHoisted_rangeBy_(start, finish, step, this, arguments, var=var):
            ...
            var.registers(['nb', 'cut', 'cur', 'step', 'i_finish', 'start', 'i', 'finish', 'arr'])
            var.put('cut', ((var.get('finish')-var.get('start'))|Js(0.0)))
        ...
        def PyJsHoisted_zip_(xs, ys, this, arguments, var=var):
            ...
            var.registers(['s', 'i_finish', 'lenx', 'i', 'len', 'leny', 'xs', 'ys'])
        ...
        def PyJsHoisted_zipByU_(xs, ys, f, this, arguments, var=var):
            ...
            var.registers(['s', 'i_finish', 'lenx', 'i', 'len', 'f', 'leny', 'xs', 'ys'])
            var.put('lenx', var.get('xs').get('length'))
            var.put('leny', var.get('ys').get('length'))
            var.put('len', (var.get('lenx') if (var.get('lenx')<var.get('leny')) else var.get('leny')))
            var.put('s', var.get('Array').create(var.get('len')))
        ...
        def PyJsHoisted_concat_(a1, a2, this, arguments, var=var):
            ...
            var.registers(['a2', 'i_finish', 'l2', 'a1', 'i', 'l1', 'i$1', 'i_finish$1', 'a1a2'])
        ...
        def PyJsHoisted_concatMany_(arrs, this, arguments, var=var):
            ...
            var.registers(['k_finish', 'cur', 'result', 'i_finish', 'lenArrs', 'i', 'k', 'j_finish', 'j', 'totalLen', 'arrs'])
        ...
        def PyJsHoisted_slice_(a, offset, len, this, arguments, var=var):
            ...
            var.registers(['result', 'hasLen', 'i_finish', 'a', 'copyLength', 'ofs', 'i', 'len', 'offset', 'lena'])
        ...
        def PyJsHoisted_sliceToEnd_(a, offset, this, arguments, var=var):
            ...
            var.registers(['result', 'i_finish', 'a', 'ofs', 'i', 'len', 'offset', 'lena'])
            var.put('lena', var.get('a').get('length'))
            var.put('ofs', (var.get('Caml_primitive').callprop('caml_int_max', ((var.get('lena')+var.get('offset'))|Js(0.0)), Js(0.0)) if (var.get('offset')<Js(0.0)) else var.get('offset')))
        ...
        def PyJsHoisted_fill_(a, offset, len, v, this, arguments, var=var):
            ...
            var.registers(['hasLen', 'i_finish', 'a', 'ofs', 'i', 'len', 'fillLength', 'v', 'offset', 'lena'])
            if (var.get('len')>Js(0.0)):
                var.put('lena', var.get('a').get('length'))
                var.put('ofs', (var.get('Caml_primitive').callprop('caml_int_max', ((var.get('lena')+var.get('offset'))|Js(0.0)), Js(0.0)) if (var.get('offset')<Js(0.0)) else var.get('offset')))
                var.put('hasLen', ((var.get('lena')-var.get('ofs'))|Js(0.0)))
        ...
        def PyJsHoisted_blitUnsafe_(a1, srcofs1, a2, srcofs2, blitLength, this, arguments, var=var):
            ...
            var.registers(['a2', 'blitLength', 'j$1', 'srcofs1', 'a1', 'srcofs2', 'j_finish', 'j'])
        ...
        def PyJsHoisted_blit_(a1, ofs1, a2, ofs2, len, this, arguments, var=var):
            ...
            var.registers(['a2', 'blitLength', 'ofs2', 'lena1', 'j$1', 'srcofs1', 'lena2', 'a1', 'ofs1', 'len', 'srcofs2', 'j_finish', 'j'])
        ...
        def PyJsHoisted_mapU_(a, f, this, arguments, var=var):
            var = Scope({'a':a, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['i_finish', 'a', 'i', 'f', 'r', 'l'])
        ...
        def PyJsHoisted_keepU_(a, f, this, arguments, var=var):
            var = Scope({'a':a, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['i_finish', 'a', 'i', 'f', 'v', 'r', 'l', 'j'])
            var.put('l', var.get('a').get('length'))
            var.put('r', var.get('Array').create(var.get('l')))
            var.put('j', Js(0.0))
            #for JS loop
        ...
        def PyJsHoisted_keepMapU_(a, f, this, arguments, var=var):
            var = Scope({'a':a, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['i_finish', 'match', 'a', 'i', 'f', 'v', 'r', 'l', 'j'])
            var.put('l', var.get('a').get('length'))
            var.put('r', var.get('Array').create(var.get('l')))
            var.put('j', Js(0.0))
            #for JS loop
        ...
        def PyJsHoisted_reduceU_(a, x, f, this, arguments, var=var):
            ...
            var.registers(['i_finish', 'a', 'i', 'f', 'r', 'x'])
            var.put('r', var.get('x'))
            #for JS loop
            var.put('i', Js(0.0))
            var.put('i_finish', ((var.get('a').get('length')-Js(1.0))|Js(0.0)))
        ...
        def PyJsHoisted_everyU_(arr, b, this, arguments, var=var):
            ...
            var.registers(['b$1', '_i', 'len$1', 'len', 'i', 'arr$1', 'b', 'arr'])
        ...
        def PyJsHoisted_everyAux2_(arr1, arr2, _i, b, len, this, arguments, var=var):
            ...
            var.registers(['arr2', '_i', 'arr1', 'i', 'len', 'b'])
            while Js(True):
                var.put('i', var.get('_i'))
        ...
        def PyJsHoisted_some2U_(a, b, p, this, arguments, var=var):
            var = Scope({'a':a, 'b':b, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['b$1', 'arr2', '_i', 'a', 'len', 'arr1', 'i', 'b', 'p'])
        ...
        def PyJsHoisted_cmpU_(a, b, p, this, arguments, var=var):
            var = Scope({'a':a, 'b':b, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['b$1', 'arr2', '_i', 'a', 'lenb', 'p', 'c', 'arr1', 'len', 'i', 'b', 'lena'])
            var.put('lena', var.get('a').get('length'))
            var.put('lenb', var.get('b').get('length'))
        ...
        def PyJsHoisted_partitionU_(a, f, this, arguments, var=var):
            var = Scope({'a':a, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['a2', 'ii_finish', 'ii', 'a', 'a1', 'i', 'f', 'v', 'j', 'l'])
            var.put('l', var.get('a').get('length'))
            var.put('i', Js(0.0))
            var.put('j', Js(0.0))
        ...
        def PyJsHoisted_unzip_(a, this, arguments, var=var):
            ...
            var.registers(['a2', 'i_finish', 'match', 'a', 'a1', 'i', 'l'])
            var.put('l', var.get('a').get('length'))
            var.put('a1', var.get('Array').create(var.get('l')))
            var.put('a2', var.get('Array').create(var.get('l')))
            #for JS loop
    ...
    def PyJs_anonymous_1_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['require', 'comparable', 'module', 'hashable', 'MakeHashable', 'Curry', 'MakeComparableU', 'hashableU', 'MakeHashableU', 'exports', 'comparableU', 'MakeComparable'])
        @Js
        ...
        def PyJsHoisted_MakeHashable_(M, this, arguments, var=var):
            var = Scope({'M':M, 'this':this, 'arguments':arguments}, var)
            var.registers(['eq$1', 'hash$1', 'M', 'hash', 'eq'])
        ...
        def PyJsHoisted_hashable_(hash, eq, this, arguments, var=var):
            var = Scope({'hash':hash, 'eq':eq, 'this':this, 'arguments':arguments}, var)
            var.registers(['hash', 'eq$1', 'eq', 'hash$1'])
            var.put('hash$1', var.get('Curry').callprop('__1', var.get('hash')))
            var.put('eq$1', var.get('Curry').callprop('__2', var.get('eq')))
            return Js({'hash':var.get('hash$1'),'eq':var.get('eq$1')})
    ...
    def PyJs_anonymous_2_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['copyAuxWithMap2', 'make', 'every2', 'reduce2U', 'makeBy', 'forEach2U', 'mapReverseU', 'reduceReverse2UnsafeU', 'reverseConcat', 'eqU', 'mapU', 'setAssoc', 'keepWithIndexU', 'zipAux', 'copyAuxCont', 'concat', 'require', 'reduceU', 'keepWithIndex', 'some2U', 'every2U', 'size', 'Curry', 'copyAuxWithMap', 'sortU', 'Belt_Array', 'module', 'getBy', 'length', 'fromArray', 'everyU', 'some2', 'hasAssoc', 'setAssocU', 'Caml_option', 'unzip', 'reduceReverse2U', 'concatMany', 'add', 'sort', 'mapReverse2', 'forEach2', 'map', 'keepMap', 'copyAuxWitFilterMap', 'keep', 'cmpU', 'reduceReverse2', 'zipByU', 'forEachWithIndex', 'take', 'hasAssocU', 'removeAssocAuxWithMap', 'removeAssocU', 'splitAtAux', 'eq', 'splitAux', 'fillAux', 'some', 'keepMapU', 'makeByU', 'forEachWithIndexU', 'drop', 'head', 'cmp', 'Belt_SortArray', 'tail', 'reduce2', 'shuffle', 'mapWithIndexU', 'splitAt', 'filterWithIndex', 'reverse', 'flatten', 'get', 'has', 'getByU', 'hasU', 'someU', 'removeAssoc', 'forEachU', 'mapWithIndex', 'getAssoc', 'reduceWithIndex', 'reduceReverseUnsafeU', 'copyAuxWithFilterIndex', 'setAssocAuxWithMap', 'headExn', 'mapReverse', 'keepU', 'takeAux', 'every', 'reduceReverseU', 'getAssocU', 'partitionAux', 'forEach', 'reduce', 'filter', 'tailExn', 'reduceWithIndexU', 'zipBy', 'exports', 'copyAuxWithMapI', 'copyAuxWitFilter', 'flattenAux', 'reduceReverse', 'cmpByLength', 'partition', 'zip', 'partitionU', 'toArray', 'getExn', 'mapReverse2U'])
        @Js
        ...
        def PyJsHoisted_get_(x, n, this, arguments, var=var):
            ...
            var.registers(['_n', '_x', 'x$1', 'n', 'n$1', 'x'])
            if (var.get('n')<Js(0.0)):
        ...
        def PyJsHoisted_partitionAux_(p, _cell, _precX, _precY, this, arguments, var=var):
            ...
            var.registers(['h', 'precX', '_precY', '_precX', 'precY', 'cell', '_cell', 't', 'next', 'p'])
            while Js(True):
        ...
        def PyJsHoisted_splitAux_(_cell, _precX, _precY, this, arguments, var=var):
            ...
            var.registers(['precX', 'match', '_precY', '_precX', 'precY', 'cell', 'nextB', 'nextA', '_cell'])
            while Js(True):
                var.put('precY', var.get('_precY'))
                var.put('precX', var.get('_precX'))
                var.put('cell', var.get('_cell'))
        ...
        def PyJsHoisted_copyAuxCont_(_cellX, _prec, this, arguments, var=var):
            ...
            var.registers(['_prec', 'prec', 'cellX', '_cellX', 'next'])
            while Js(True):
        ...
        def PyJsHoisted_copyAuxWitFilter_(f, _cellX, _prec, this, arguments, var=var):
            ...
            var.registers(['h', '_prec', 'prec', 'f', 'cellX', 't', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
                if var.get('cellX'):
        ...
        def PyJsHoisted_copyAuxWithFilterIndex_(f, _cellX, _prec, _i, this, arguments, var=var):
            ...
            var.registers(['h', '_prec', '_i', 'prec', 'i', 'f', 'cellX', 't', '_cellX', 'next'])
            while Js(True):
                var.put('i', var.get('_i'))
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
        ...
        def PyJsHoisted_copyAuxWitFilterMap_(f, _cellX, _prec, this, arguments, var=var):
            var = Scope({'f':f, '_cellX':_cellX, '_prec':_prec, 'this':this, 'arguments':arguments}, var)
            var.registers(['_prec', 'prec', 'match', 'f', 'cellX', 't', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
                if var.get('cellX'):
        ...
        def PyJsHoisted_removeAssocAuxWithMap_(_cellX, x, _prec, f, this, arguments, var=var):
            ...
            var.registers(['h', '_prec', 'prec', 'f', 'x', 'cellX', 't', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
                if var.get('cellX'):
        ...
        def PyJsHoisted_setAssocAuxWithMap_(_cellX, x, k, _prec, eq, this, arguments, var=var):
            ...
            var.registers(['h', '_prec', 'prec', 'eq', 'k', 'x', 'cellX', 't', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
                if var.get('cellX'):
        ...
        def PyJsHoisted_copyAuxWithMap_(_cellX, _prec, f, this, arguments, var=var):
            ...
            var.registers(['_prec', 'prec', 'f', 'cellX', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
                if var.get('cellX'):
        ...
        def PyJsHoisted_zipAux_(_cellX, _cellY, _prec, this, arguments, var=var):
            ...
            var.registers(['cellY', '_prec', 'prec', '_cellY', 'cellX', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
        ...
        def PyJsHoisted_copyAuxWithMap2_(f, _cellX, _cellY, _prec, this, arguments, var=var):
            ...
            var.registers(['cellY', '_prec', 'prec', 'f', '_cellY', 'cellX', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellY', var.get('_cellY'))
                var.put('cellX', var.get('_cellX'))
        ...
        def PyJsHoisted_copyAuxWithMapI_(f, _i, _cellX, _prec, this, arguments, var=var):
            ...
            var.registers(['_prec', '_i', 'prec', 'i', 'f', 'cellX', '_cellX', 'next'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cellX', var.get('_cellX'))
                var.put('i', var.get('_i'))
        ...
        def PyJsHoisted_takeAux_(_n, _cell, _prec, this, arguments, var=var):
            ...
            var.registers(['_n', 'cell$1', '_prec', 'prec', 'n', 'cell', '_cell'])
            while Js(True):
                var.put('prec', var.get('_prec'))
                var.put('cell', var.get('_cell'))
        ...
        def PyJsHoisted_drop_(lst, n, this, arguments, var=var):
            var = Scope({'lst':lst, 'n':n, 'this':this, 'arguments':arguments}, var)
            var.registers(['_n', 'n', 'n$1', 'l', 'lst', '_l'])
            if (var.get('n')<Js(0.0)):
                return var.get('undefined')
            else:
        ...
        def PyJsHoisted_makeByU_(n, f, this, arguments, var=var):
            ...
            var.registers(['cur', 'headX', 'n', 'i', 'f', 'v'])
            if (var.get('n')<=Js(0.0)):
                return Js(0.0)
            else:
        ...
        def PyJsHoisted_make_(n, v, this, arguments, var=var):
            ...
            var.registers(['cur', 'headX', 'n', 'i', 'v$1', 'v'])
            if (var.get('n')<=Js(0.0)):
                return Js(0.0)
            else:
        ...
        def PyJsHoisted_length_(xs, this, arguments, var=var):
            var = Scope({'xs':xs, 'this':this, 'arguments':arguments}, var)
            var.registers(['_x', '_acc', 'acc', 'x', 'xs'])
        ...
        def PyJsHoisted_fromArray_(a, this, arguments, var=var):
            var = Scope({'a':a, 'this':this, 'arguments':arguments}, var)
            var.registers(['a$1', '_i', 'a', 'i', '_res', 'res'])
        ...
        def PyJsHoisted_flattenAux_(_prec, _xs, this, arguments, var=var):
            ...
            var.registers(['_xs', 'prec', 'xs', '_prec'])
            while Js(True):
        ...
        def PyJsHoisted_flatten_(_xs, this, arguments, var=var):
            ...
            var.registers(['_xs', 'cell', 'match', 'xs'])
            while Js(True):
                var.put('xs', var.get('_xs'))
                if var.get('xs'):
        ...
        def PyJsHoisted_concatMany_(xs, this, arguments, var=var):
            var = Scope({'xs':xs, 'this':this, 'arguments':arguments}, var)
            var.registers(['len$1', 'i', 'len', 'v', 'xs'])
            var.put('len', var.get('xs').get('length'))
        ...
        def PyJsHoisted_mapReverseU_(l, f, this, arguments, var=var):
            var = Scope({'l':l, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['_accu', 'f$1', 'accu', 'f', 'l', '_xs', 'xs'])
        ...
        def PyJsHoisted_forEachWithIndexU_(l, f, this, arguments, var=var):
            var = Scope({'l':l, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['_i', 'f$1', 'i', 'f', 'l', '_xs', 'xs'])
            var.put('_xs', var.get('l'))
            var.put('_i', Js(0.0))
            var.put('f$1', var.get('f'))
            while Js(True):
        ...
        def PyJsHoisted_reduceU_(_l, _accu, f, this, arguments, var=var):
            ...
            var.registers(['_accu', 'accu', 'f', 'l', '_l'])
            while Js(True):
                var.put('accu', var.get('_accu'))
                var.put('l', var.get('_l'))
                if var.get('l'):
        ...
        def PyJsHoisted_reduceWithIndexU_(l, acc, f, this, arguments, var=var):
            var = Scope({'l':l, 'acc':acc, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['acc$1', '_acc', 'f$1', '_i', 'acc', 'i', 'f', 'l', 'l$1', '_l'])
        ...
        def PyJsHoisted_mapReverse2U_(l1, l2, f, this, arguments, var=var):
            var = Scope({'l1':l1, 'l2':l2, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['_l2', '_accu', 'f$1', 'l2', 'accu', 'l1', 'f', 'l2$1', '_l1', 'l1$1'])
        ...
        def PyJsHoisted_reduce2U_(_l1, _l2, _accu, f, this, arguments, var=var):
            ...
            var.registers(['_l2', '_accu', 'l2', 'accu', 'l1', '_l1', 'f'])
            while Js(True):
                var.put('accu', var.get('_accu'))
                var.put('l2', var.get('_l2'))
                var.put('l1', var.get('_l1'))
        ...
        def PyJsHoisted_cmpU_(_l1, _l2, p, this, arguments, var=var):
            var = Scope({'_l1':_l1, '_l2':_l2, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['_l2', 'l2', 'c', 'l1', '_l1', 'p'])
            while Js(True):
                var.put('l2', var.get('_l2'))
                var.put('l1', var.get('_l1'))
                if var.get('l1'):
        ...
        def PyJsHoisted_getAssocU_(_xs, x, eq, this, arguments, var=var):
            var = Scope({'_xs':_xs, 'x':x, 'eq':eq, 'this':this, 'arguments':arguments}, var)
            var.registers(['match', 'eq', '_xs', 'x', 'xs'])
            while Js(True):
                var.put('xs', var.get('_xs'))
                if var.get('xs'):
                    var.put('match', var.get('xs').get('0'))
        ...
        def PyJsHoisted_removeAssocU_(xs, x, eq, this, arguments, var=var):
            var = Scope({'xs':xs, 'x':x, 'eq':eq, 'this':this, 'arguments':arguments}, var)
            var.registers(['cell', 'eq', 'pair', 'xs', 'x', 'l', 'removed'])
            if var.get('xs'):
        ...
        def PyJsHoisted_setAssocU_(xs, x, k, eq, this, arguments, var=var):
            ...
            var.registers(['replaced', 'cell', 'k', 'eq', 'pair', 'xs', 'x', 'l'])
            if var.get('xs'):
                var.put('l', var.get('xs').get('1'))
                var.put('pair', var.get('xs').get('0'))
                if var.get('eq')(var.get('pair').get('0'), var.get('x')):
        ...
        def PyJsHoisted_keepU_(_xs, p, this, arguments, var=var):
            var = Scope({'_xs':_xs, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['h', 'cell', '_xs', 'xs', 't', 'p'])
            while Js(True):
                var.put('xs', var.get('_xs'))
                if var.get('xs'):
        ...
        def PyJsHoisted_keepWithIndexU_(xs, p, this, arguments, var=var):
            var = Scope({'xs':xs, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['h', 'xs$1', 'p$1', '_i', 'i', 'cell', '_xs', 'xs', 't', 'p'])
        ...
        def PyJsHoisted_keepMapU_(_xs, p, this, arguments, var=var):
            var = Scope({'_xs':_xs, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['match', 'cell', '_xs', 'xs', 't', 'p'])
            while Js(True):
                var.put('xs', var.get('_xs'))
                if var.get('xs'):
                    var.put('t', var.get('xs').get('1'))
        ...
        def PyJsHoisted_partitionU_(l, p, this, arguments, var=var):
            ...
            var.registers(['h', 'nextY', 'nextX', 'b', 'l', 'p'])
            if var.get('l'):
        ...
        def PyJsHoisted_unzip_(xs, this, arguments, var=var):
            var = Scope({'xs':xs, 'this':this, 'arguments':arguments}, var)
            var.registers(['cellX', 'match', 'cellY', 'xs'])
            if var.get('xs'):
                var.put('match', var.get('xs').get('0'))
    ...
    def PyJs_anonymous_3_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['forEachU', 'findFirstBy', 'make', 'minUndefined', 'module', 'maxKeyUndefined', 'keysToArray', 'getData', 'removeMany', 'getWithDefault', 'fromArray', 'everyU', 'minKey', 'mergeU', 'some', 'keepU', 'eqU', 'mapU', 'maxKey', 'every', 'getUndefined', 'valuesToArray', 'remove', 'cmp', 'split', 'mergeMany', 'getId', 'mapWithKeyU', '$$String', 'isEmpty', 'forEach', 'set', 'reduce', 'map', 'update', 'toList', 'mapWithKey', 'minKeyUndefined', 'keep', 'get', 'cmpU', 'Int', 'merge', 'has', 'require', 'exports', 'reduceU', 'findFirstByU', 'checkInvariantInternal', 'minimum', 'Dict', 'partition', 'maxUndefined', 'updateU', 'maximum', 'size', 'Curry', 'someU', 'partitionU', 'packIdData', 'eq', 'toArray', 'Belt_MapDict', 'getExn'])
        @Js
        def PyJsHoisted_fromArray_(data, id, this, arguments, var=var):
            var = Scope({'data':data, 'id':id, 'this':this, 'arguments':arguments}, var)
            var.registers(['cmp', 'data', 'id'])
        ...
        def PyJsHoisted_remove_(m, x, this, arguments, var=var):
            ...
            var.registers(['newData', 'odata', 'cmp', 'm', 'x'])
            var.put('cmp', var.get('m').get('cmp'))
        ...
        def PyJsHoisted_split_(m, x, this, arguments, var=var):
            var = Scope({'m':m, 'x':x, 'this':this, 'arguments':arguments}, var)
            var.registers(['match$1', 'match', 'cmp', 'm', 'x'])
            var.put('cmp', var.get('m').get('cmp'))
    ...
    def PyJs_anonymous_4_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['forEachU', 'findFirstBy', 'minUndefined', 'module', 'maxKeyUndefined', 'keysToArray', 'removeMany', 'getWithDefault', 'everyU', 'fromArray', 'minKey', 'mergeU', 'some', 'keepU', 'Caml_option', 'eqU', 'maxKey', 'mapU', 'every', 'getUndefined', 'valuesToArray', 'remove', 'cmp', 'split', 'mergeMany', 'Belt_internalAVLtree', 'removeAux0', 'mapWithKeyU', 'isEmpty', 'forEach', 'set', 'reduce', 'minKeyUndefined', 'update', 'empty', 'map', 'mapWithKey', 'keep', 'cmpU', 'get', 'has', 'merge', 'require', 'exports', 'reduceU', 'findFirstByU', 'checkInvariantInternal', 'minimum', 'splitAuxPivot', 'maxUndefined', 'partition', 'updateU', 'maximum', 'size', 'Curry', 'someU', 'partitionU', 'eq', 'toArray', 'toList', 'getExn'])
        @Js
        def PyJsHoisted_set_(t, newK, newD, cmp, this, arguments, var=var):
            ...
            var.registers(['newK', 'newD', 'c', 'l', 'k', 'r', 'cmp', 'v', 't'])
        ...
        def PyJsHoisted_updateU_(t, newK, f, cmp, this, arguments, var=var):
            ...
            var.registers(['match$1', 'newK', 'vr', 'r$1', 'll', 'rr', 'match', 'c', 'f', 'v', 'r$2', 'k', 'r', 'kr', 'cmp', 'l', 'l$1', 't'])
            if PyJsStrictNeq(var.get('t'),var.get(u"null")):
                var.put('k', var.get('t').get('key'))
                var.put('c', var.get('cmp')(var.get('newK'), var.get('k')))
                if PyJsStrictEq(var.get('c'),Js(0.0)):
        ...
        def PyJsHoisted_removeAux0_(n, x, cmp, this, arguments, var=var):
            ...
            var.registers(['vr', 'r$1', 'll', 'rr', 'cmp', 'c', 'n', 'l', 'r', 'kr', 'x', 'v'])
        ...
        def PyJsHoisted_mergeMany_(h, arr, cmp, this, arguments, var=var):
            ...
            var.registers(['h', 'i_finish', 'match', 'i', 'len', 'cmp', 'v', 'arr'])
            var.put('len', var.get('arr').get('length'))
            var.put('v', var.get('h'))
            #for JS loop
            var.put('i', Js(0.0))
        ...
        def PyJsHoisted_splitAuxPivot_(n, x, pres, cmp, this, arguments, var=var):
            ...
            var.registers(['match$1', 'match', 'cmp', 'd', 'c', 'n', 'l', 'r', 'x', 'v', 'pres'])
            var.put('l', var.get('n').get('left'))
            var.put('v', var.get('n').get('key'))
        ...
        def PyJsHoisted_mergeU_(s1, s2, f, cmp, this, arguments, var=var):
            ...
            var.registers(['newD', 'newD$1', 'd2$1', 'r1', 'd1', 's2', 'd1$2', 'match$1', 'newRight$1', 'l2', 'r2', 'cmp', 'v2', 'match', 'd1$1', 'd2', 'newRight', 'newLeft', 's1', 'newLeft$1', 'd2$2', 'v1', 'l1', 'f'])
        ...
        def PyJsHoisted_removeMany_(t, keys, cmp, this, arguments, var=var):
            ...
            var.registers(['cmp$1', '_t', '_i', 'len$1', 't$1', 'len', 'i', 'keys', 'u', 'cmp', 'xs', 't', 'ele'])
    ...
    def PyJs_anonymous_7_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['forEachU', 'module', 'getWithDefault', 'isNone', 'Caml_option', 'eqU', 'mapU', 'mapWithDefaultU', 'cmp', 'forEach', 'map', 'flatMap', 'flatMapU', 'cmpU', 'exports', 'require', 'mapWithDefault', 'Curry', 'isSome', 'eq', 'getExn'])
        @Js
    ...
    def PyJs_anonymous_8_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['forEachU', 'make', 'minUndefined', 'module', 'getData', 'removeMany', 'fromArray', 'everyU', 'intersect', 'some', 'keepU', 'every', 'diff', 'getUndefined', 'remove', 'cmp', 'union', 'split', 'add', 'mergeMany', 'fromSortedArrayUnsafe', 'getId', '$$String', 'isEmpty', 'forEach', 'reduce', 'keep', 'get', 'Belt_SetDict', 'has', 'Int', 'require', 'exports', 'reduceU', 'subset', 'checkInvariantInternal', 'minimum', 'Dict', 'partition', 'maxUndefined', 'maximum', 'size', 'Curry', 'someU', 'partitionU', 'packIdData', 'eq', 'toArray', 'toList', 'getExn'])
        @Js
        def PyJsHoisted_fromArray_(data, id, this, arguments, var=var):
            var = Scope({'data':data, 'id':id, 'this':this, 'arguments':arguments}, var)
            var.registers(['cmp', 'data', 'id'])
        ...
        def PyJsHoisted_remove_(m, e, this, arguments, var=var):
            var = Scope({'m':m, 'e':e, 'this':this, 'arguments':arguments}, var)
            var.registers(['newData', 'm', 'e', 'cmp', 'data'])
            var.put('cmp', var.get('m').get('cmp'))
        ...
        def PyJsHoisted_split_(m, e, this, arguments, var=var):
            var = Scope({'m':m, 'e':e, 'this':this, 'arguments':arguments}, var)
            var.registers(['match$1', 'match', 'm', 'e', 'cmp'])
            var.put('cmp', var.get('m').get('cmp'))
    ...
    def PyJs_anonymous_9_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['forEachU', 'minUndefined', 'module', 'Belt_internalAVLset', 'removeMany', 'fromArray', 'everyU', 'intersect', 'some', 'keepU', 'every', 'diff', 'getUndefined', 'getExn', 'remove', 'cmp', 'union', 'split', 'add', 'mergeMany', 'fromSortedArrayUnsafe', 'isEmpty', 'forEach', 'reduce', 'empty', 'keep', 'get', 'has', 'exports', 'require', 'reduceU', 'subset', 'checkInvariantInternal', 'minimum', 'splitAuxPivot', 'partition', 'maxUndefined', 'maximum', 'size', 'someU', 'partitionU', 'eq', 'toArray', 'toList', 'splitAuxNoPivot'])
        @Js
        def PyJsHoisted_add_(t, x, cmp, this, arguments, var=var):
            var = Scope({'t':t, 'x':x, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['ll', 'rr', 'cmp', 'c', 'k', 'r', 'x', 'l', 't'])
            if PyJsStrictNeq(var.get('t'),var.get(u"null")):
        ...
        def PyJsHoisted_remove_(t, x, cmp, this, arguments, var=var):
            var = Scope({'t':t, 'x':x, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['r$1', 'll', 'rr', 'cmp', 'c', 'l', 'v$1', 'r', 'x', 'v', 't'])
            if PyJsStrictNeq(var.get('t'),var.get(u"null")):
                var.put('l', var.get('t').get('left'))
                var.put('v', var.get('t').get('value'))
                var.put('r', var.get('t').get('right'))
        ...
        def PyJsHoisted_mergeMany_(h, arr, cmp, this, arguments, var=var):
            var = Scope({'h':h, 'arr':arr, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['h', 'key', 'i_finish', 'i', 'len', 'cmp', 'v', 'arr'])
            var.put('len', var.get('arr').get('length'))
            var.put('v', var.get('h'))
            #for JS loop
            var.put('i', Js(0.0))
        ...
        def PyJsHoisted_splitAuxNoPivot_(cmp, n, x, this, arguments, var=var):
            ...
            var.registers(['match$1', 'match', 'c', 'n', 'l', 'r', 'x', 'cmp', 'v'])
            var.put('l', var.get('n').get('left'))
        ...
        def PyJsHoisted_splitAuxPivot_(cmp, n, x, pres, this, arguments, var=var):
            ...
            var.registers(['match$1', 'match', 'c', 'n', 'l', 'r', 'x', 'cmp', 'v', 'pres'])
            var.put('l', var.get('n').get('left'))
            var.put('v', var.get('n').get('value'))
            var.put('r', var.get('n').get('right'))
            var.put('c', var.get('cmp')(var.get('x'), var.get('v')))
        ...
        def PyJsHoisted_union_(s1, s2, cmp, this, arguments, var=var):
            ...
            var.registers(['match$1', 's1', 'v2', 'match', 'l2', 'v1', 'r1', 'l1', 'h1', 'h2', 'r2', 's2', 'cmp'])
            if PyJsStrictNeq(var.get('s1'),var.get(u"null")):
                if PyJsStrictNeq(var.get('s2'),var.get(u"null")):
        ...
        def PyJsHoisted_intersect_(s1, s2, cmp, this, arguments, var=var):
            var = Scope({'s1':s1, 's2':s2, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['s1', 'rr', 'match', 'v1', 'r1', 'l1', 's2', 'll', 'cmp', 'pres'])
    ...
    def PyJs_anonymous_10_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['insertionSort', 'Belt_Array', 'strictlySortedLength', 'module', 'sortTo', 'sortedLengthAuxMore', 'intersect', 'diffU', 'unionU', 'binarySearchBy', 'isSortedU', 'diff', 'union', '$$String', 'stableSortBy', 'strictlySortedLengthU', 'stableSortInPlaceByU', 'intersectU', 'merge', 'binarySearchByU', 'Int', 'require', 'exports', 'stableSortByU', 'stableSortInPlaceBy', 'Curry', 'isSorted'])
        @Js
        def PyJsHoisted_sortedLengthAuxMore_(xs, _prec, _acc, len, lt, this, arguments, var=var):
            ...
            var.registers(['_prec', '_acc', 'acc', 'prec', 'lt', 'len', 'xs', 'v'])
            while Js(True):
                var.put('acc', var.get('_acc'))
                var.put('prec', var.get('_prec'))
        ...
        def PyJsHoisted_strictlySortedLengthU_(xs, lt, this, arguments, var=var):
            ...
            var.registers(['xs$1', '_prec', '_acc', 'acc', 'len$1', 'prec', 'lt', 'len', 'x0', 'x1', 'lt$1', 'xs', 'v'])
            var.put('len', var.get('xs').get('length'))
        ...
        def PyJsHoisted_isSortedU_(a, cmp, this, arguments, var=var):
            ...
            var.registers(['cmp$1', 'a$1', '_i', 'a', 'last_bound', 'len', 'i', 'cmp'])
        ...
        def PyJsHoisted_merge_(src, src1ofs, src1len, src2, src2ofs, src2len, dst, dstofs, cmp, this, arguments, var=var):
            ...
            var.registers(['_i1', 's2', '_d', 'src2len', 'dstofs', 'dst', 'd', '_i2', 'src1len', 'src2', 'src1ofs', 'cmp', '_s1', 'i2', 's1', 'i2$1', 'i1$1', 'src', 'src2r', 'i1', 'src2ofs', 'src1r', '_s2'])
        ...
        def PyJsHoisted_unionU_(src, src1ofs, src1len, src2, src2ofs, src2len, dst, dstofs, cmp, this, arguments, var=var):
            var = Scope({'src':src, 'src1ofs':src1ofs, 'src1len':src1len, 'src2':src2, 'src2ofs':src2ofs, 'src2len':src2len, 'dst':dst, 'dstofs':dstofs, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['_i1', 's2', 'i2$2', '_d', 'src2len', 'dstofs', 'dst', 'd', '_i2', 'd$3', 'd$2', 'src1len', 'src2', 'src1ofs', 'cmp', '_s1', 'i2', 's1', 'i2$1', 'i1$1', 'src', 'c', 'src2r', 'i1', 'src2ofs', 'src1r', 'd$1', 'i1$2', '_s2'])
            var.put('src1r', ((var.get('src1ofs')+var.get('src1len'))|Js(0.0)))
            var.put('src2r', ((var.get('src2ofs')+var.get('src2len'))|Js(0.0)))
            var.put('_i1', var.get('src1ofs'))
            var.put('_s1', var.get('src').get(var.get('src1ofs')))
        ...
        def PyJsHoisted_union_(src, src1ofs, src1len, src2, src2ofs, src2len, dst, dstofs, cmp, this, arguments, var=var):
            var = Scope({'src':src, 'src1ofs':src1ofs, 'src1len':src1len, 'src2':src2, 'src2ofs':src2ofs, 'src2len':src2len, 'dst':dst, 'dstofs':dstofs, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['dst', 'src', 'cmp', 'src2ofs', 'dstofs', 'src2len', 'src1len', 'src2', 'src1ofs'])
        ...
        def PyJsHoisted_intersectU_(src, src1ofs, src1len, src2, src2ofs, src2len, dst, dstofs, cmp, this, arguments, var=var):
            var = Scope({'src':src, 'src1ofs':src1ofs, 'src1len':src1len, 'src2':src2, 'src2ofs':src2ofs, 'src2len':src2len, 'dst':dst, 'dstofs':dstofs, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['_i1', 's2', 'i2$2', '_d', 'src2len', 'dstofs', 'dst', 'd', '_i2', 'src1len', 'src2', 'src1ofs', 'cmp', '_s1', 'i2', 's1', 'i2$1', 'i1$1', 'src', 'c', 'src2r', 'i1', 'src2ofs', 'src1r', 'd$1', 'i1$2', '_s2'])
            var.put('src1r', ((var.get('src1ofs')+var.get('src1len'))|Js(0.0)))
            var.put('src2r', ((var.get('src2ofs')+var.get('src2len'))|Js(0.0)))
            var.put('_i1', var.get('src1ofs'))
            var.put('_s1', var.get('src').get(var.get('src1ofs')))
        ...
        def PyJsHoisted_insertionSort_(src, srcofs, dst, dstofs, len, cmp, this, arguments, var=var):
            ...
            var.registers(['srcofs', 'dst', 'src', 'i_finish', 'i', 'len', 'e', 'dstofs', 'j', 'cmp'])
            #for JS loop
            var.put('i', Js(0.0))
            var.put('i_finish', ((var.get('len')-Js(1.0))|Js(0.0)))
            while (var.get('i')<=var.get('i_finish')):
        ...
        def PyJsHoisted_sortTo_(src, srcofs, dst, dstofs, len, cmp, this, arguments, var=var):
            var = Scope({'src':src, 'srcofs':srcofs, 'dst':dst, 'dstofs':dstofs, 'len':len, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['srcofs', 'dst', 'src', 'l2', 'l1', 'len', 'dstofs', 'cmp'])
        ...
        def PyJsHoisted_binarySearchByU_(sorted, key, cmp, this, arguments, var=var):
            ...
            var.registers(['cmp$1', 'key', 'hi', 'hi$1', 'sorted', 'c$1', 'cmp', 'c', 'len', 'key$1', 'lo$1', 'mid', 'midVal', 'lo', '_hi', 'c2', 'arr', '_lo'])
    ...
    def PyJs_anonymous_11_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['forEachU', 'fillArrayWithPartition', 'heightGe', 'minUndefined', 'lengthNode', 'module', 'create', 'everyU', 'concatShared', 'fromArray', 'max0Aux', 'some', 'balMutate', 'partitionCopyU', 'Caml_option', 'rotateWithLeftChild', 'toListAux', 'partitionShared', 'every', 'fromSortedArrayRevAux', 'getUndefined', 'singleton', 'keepCopy', 'cmp', 'Belt_SortArray', 'doubleWithLeftChild', 'fromSortedArrayUnsafe', 'keepShared', 'addMutate', 'keepCopyU', 'partitionSharedU', 'fillArrayWithFilter', 'keepSharedU', 'isEmpty', 'removeMinAuxWithRef', 'forEach', 'reduce', 'treeHeight', 'addMinElement', 'addMaxElement', 'toList', 'fillArray', 'fromSortedArrayAux', 'partitionCopy', 'min0Aux', 'get', 'has', 'exports', 'require', 'reduceU', 'subset', 'heightUpdateMutate', 'removeMinAuxWithRootMutate', 'checkInvariantInternal', 'rotateWithRightChild', 'minimum', 'joinShared', 'maxUndefined', 'maximum', 'copy', 'size', 'Curry', 'bal', 'someU', 'doubleWithRightChild', 'eq', 'toArray', 'stackAllLeft', 'getExn'])
        @Js
        ...
        def PyJsHoisted_bal_(l, v, r, this, arguments, var=var):
            var = Scope({'l':l, 'v':v, 'r':r, 'this':this, 'arguments':arguments}, var)
            var.registers(['r', 'lrr', 'rv', 'rlv', 'lrl', 'rr', 'rll', 'hr', 'lrv', 'lv', 'rlr', 'v', 'lr', 'rl', 'll', 'l', 'hl'])
            var.put('hl', (var.get('l').get('height') if PyJsStrictNeq(var.get('l'),var.get(u"null")) else Js(0.0)))
            var.put('hr', (var.get('r').get('height') if PyJsStrictNeq(var.get('r'),var.get(u"null")) else Js(0.0)))
        ...
        def PyJsHoisted_reduceU_(_s, _accu, f, this, arguments, var=var):
            ...
            var.registers(['_accu', 's', 'accu', 'f', 'k', 'r', 'l', '_s'])
            while Js(True):
                var.put('accu', var.get('_accu'))
                var.put('s', var.get('_s'))
        ...
        def PyJsHoisted_partitionSharedU_(n, p, this, arguments, var=var):
            var = Scope({'n':n, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['match$1', 'lt', 'match', 'rt', 'n', 'pv', 'value', 'rf', 'lf', 'p'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
        ...
        def PyJsHoisted_lengthNode_(n, this, arguments, var=var):
            var = Scope({'n':n, 'this':this, 'arguments':arguments}, var)
            var.registers(['n', 'sizeL', 'r', 'l', 'sizeR'])
            var.put('l', var.get('n').get('left'))
            var.put('r', var.get('n').get('right'))
        ...
        def PyJsHoisted_fillArray_(_n, _i, arr, this, arguments, var=var):
            ...
            var.registers(['_n', 'rnext', '_i', 'n', 'i', 'l', 'r', 'v', 'arr', 'next'])
            while Js(True):
                var.put('i', var.get('_i'))
                var.put('n', var.get('_n'))
                var.put('l', var.get('n').get('left'))
        ...
        def PyJsHoisted_fillArrayWithPartition_(_n, cursor, arr, p, this, arguments, var=var):
            ...
            var.registers(['_n', 'cursor', 'c$1', 'n', 'c', 'l', 'r', 'v', 'arr', 'p'])
            while Js(True):
                var.put('n', var.get('_n'))
                var.put('l', var.get('n').get('left'))
                var.put('v', var.get('n').get('value'))
        ...
        def PyJsHoisted_fillArrayWithFilter_(_n, _i, arr, p, this, arguments, var=var):
            ...
            var.registers(['_n', 'rnext', '_i', 'n', 'i', 'l', 'r', 'v', 'arr', 'next', 'p'])
            while Js(True):
                var.put('i', var.get('_i'))
                var.put('n', var.get('_n'))
                var.put('l', var.get('n').get('left'))
        ...
        def PyJsHoisted_fromSortedArrayRevAux_(arr, off, len, this, arguments, var=var):
            ...
            var.registers(['x0$1', 'right', 'x2', 'x1$1', 'left', 'mid', 'x0', 'x1', 'len', 'nl', 'arr', 'off'])
            while 1:
                SWITCHED = False
        ...
        def PyJsHoisted_keepSharedU_(n, p, this, arguments, var=var):
            var = Scope({'n':n, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['newL', 'n', 'newR', 'pv', 'l', 'r', 'v', 'p'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
                var.put('l', var.get('n').get('left'))
                var.put('v', var.get('n').get('value'))
                var.put('r', var.get('n').get('right'))
        ...
        def PyJsHoisted_partitionCopyU_(n, p, this, arguments, var=var):
            var = Scope({'n':n, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['cursor', 'forwardLen', 'n', 'size', 'v', 'backward', 'p'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
                var.put('size', var.get('lengthNode')(var.get('n')))
                var.put('v', var.get('Array').create(var.get('size')))
        ...
        def PyJsHoisted_cmp_(s1, s2, PyJsArg_636d702431_, this, arguments, var=var):
            ...
            var.registers(['cmp$1', 's1', '_e1', 'h1', 'h2', 'c', 'cmp$2', 'len2', 's2', '_e2', 'e2', 'e1', 'len1'])
        ...
        def PyJsHoisted_subset_(_s1, _s2, cmp, this, arguments, var=var):
            ...
            var.registers(['s1', '_s1', 'v2', 'l2', 'v1', 'r1', 'l1', 's2', 'r2', 'c', 'cmp', '_s2'])
            while Js(True):
                var.put('s2', var.get('_s2'))
                var.put('s1', var.get('_s1'))
                if PyJsStrictNeq(var.get('s1'),var.get(u"null")):
        ...
        def PyJsHoisted_rotateWithLeftChild_(k2, this, arguments, var=var):
            ...
            var.registers(['k2', 'hlk2', 'hk2', 'hrk2', 'k1', 'hlk1'])
        ...
        def PyJsHoisted_rotateWithRightChild_(k1, this, arguments, var=var):
            ...
            var.registers(['hk1', 'k2', 'hrk1', 'hrk2', 'k1', 'hlk1'])
        ...
        def PyJsHoisted_balMutate_(nt, this, arguments, var=var):
            ...
            var.registers(['ll', 'rr', 'nt', 'hr', 'lr', 'rl', 'r', 'l', 'hl'])
        ...
        def PyJsHoisted_addMutate_(cmp, t, x, this, arguments, var=var):
            ...
            var.registers(['ll', 'c', 'k', 'r', 'x', 'cmp', 'l', 't'])
            if PyJsStrictNeq(var.get('t'),var.get(u"null")):
                var.put('k', var.get('t').get('value'))
                var.put('c', var.get('cmp')(var.get('x'), var.get('k')))
                if PyJsStrictEq(var.get('c'),Js(0.0)):
        ...
        def PyJsHoisted_fromArray_(xs, cmp, this, arguments, var=var):
            var = Scope({'xs':xs, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['result', 'i_finish', 'i', 'len', 'cmp', 'xs', 'next'])
            var.put('len', var.get('xs').get('length'))
            if PyJsStrictEq(var.get('len'),Js(0.0)):
                return var.get(u"null")
            else:
    ...
    def PyJs_anonymous_13_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['minUndefined', 'maxKeyUndefined', 'keysToArray', 'getWithDefault', 'concatOrJoin', 'balMutate', 'eqU', 'mapU', 'minKV0Aux', 'fromSortedArrayRevAux', 'getUndefined', 'singleton', 'doubleWithLeftChild', 'mapWithKeyU', 'minKeyUndefined', 'updateValue', 'concat', 'require', 'reduceU', 'findFirstByU', 'maxKV0Aux', 'copy', 'size', 'Curry', 'bal', 'fillArrayKey', 'heightGe', 'lengthNode', 'module', 'updateMutate', 'everyU', 'minKey', 'fromArray', 'Caml_option', 'maxKey', 'partitionSharedU', 'removeMinAuxWithRef', 'map', 'treeHeight', 'keepMap', 'mapWithKey', 'cmpU', 'checkInvariantInternal', 'doubleWithRightChild', 'eq', 'findFirstBy', 'fillArrayValue', 'some', 'keepMapU', 'toListAux', 'valuesToArray', 'cmp', 'Belt_SortArray', 'fromSortedArrayUnsafe', 'keepShared', 'fillArray', 'get', 'has', 'heightUpdateMutate', 'minimum', 'maximum', 'someU', 'toList', 'forEachU', 'create', 'maxKey0Aux', 'rotateWithLeftChild', 'partitionShared', 'every', 'join', 'keepSharedU', 'isEmpty', 'fromSortedArrayAux', 'forEach', 'reduce', 'addMinElement', 'addMaxElement', 'exports', 'removeMinAuxWithRootMutate', 'rotateWithRightChild', 'maxUndefined', 'minKey0Aux', 'toArray', 'stackAllLeft', 'getExn'])
        @Js
        def PyJsHoisted_treeHeight_(n, this, arguments, var=var):
            var = Scope({'n':n, 'this':this, 'arguments':arguments}, var)
            var.registers(['n'])
        ...
        def PyJsHoisted_bal_(l, x, d, r, this, arguments, var=var):
            var = Scope({'l':l, 'x':x, 'd':d, 'r':r, 'this':this, 'arguments':arguments}, var)
            var.registers(['lrl', 'hr', 'lv', 'r', 'hl', 'rlv', 'ld', 'd', 'lr', 'rl', 'rd', 'l', 'rld', 'rlr', 'lrv', 'lrd', 'rll', 'x', 'lrr', 'rv', 'rr', 'll'])
            var.put('hl', (var.get('l').get('height') if PyJsStrictNeq(var.get('l'),var.get(u"null")) else Js(0.0)))
            var.put('hr', (var.get('r').get('height') if PyJsStrictNeq(var.get('r'),var.get(u"null")) else Js(0.0)))
            if (var.get('hl')>((var.get('hr')+Js(2.0))|Js(0.0))):
                var.put('ll', var.get('l').get('left'))
        ...
        def PyJsHoisted_removeMinAuxWithRef_(n, kr, vr, this, arguments, var=var):
            ...
            var.registers(['vr', 'n', 'kn', 'rn', 'ln', 'kr', 'vn'])
            var.put('ln', var.get('n').get('left'))
            var.put('rn', var.get('n').get('right'))
        ...
        def PyJsHoisted_findFirstByU_(n, p, this, arguments, var=var):
            var = Scope({'n':n, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['pvd', 'right', 'd', 'left', 'n', 'v', 'p'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
        ...
        def PyJsHoisted_mapU_(n, f, this, arguments, var=var):
            var = Scope({'n':n, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['newRight', 'newLeft', 'newD', 'n', 'f'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
        ...
        def PyJsHoisted_mapWithKeyU_(n, f, this, arguments, var=var):
            var = Scope({'n':n, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['newRight', 'key', 'newLeft', 'newD', 'n', 'f'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
        ...
        def PyJsHoisted_reduceU_(_m, _accu, f, this, arguments, var=var):
            ...
            var.registers(['_m', '_accu', 'm', 'd', 'accu', 'f', 'v', 'r', 'l'])
            while Js(True):
                var.put('accu', var.get('_accu'))
        ...
        def PyJsHoisted_join_(ln, v, d, rn, this, arguments, var=var):
            ...
            var.registers(['rv', 'lh', 'rr', 'ld', 'lv', 'd', 'ln', 'rn', 'lr', 'rl', 'll', 'rd', 'v', 'rh'])
            if PyJsStrictNeq(var.get('ln'),var.get(u"null")):
                if PyJsStrictNeq(var.get('rn'),var.get(u"null")):
        ...
        def PyJsHoisted_keepSharedU_(n, p, this, arguments, var=var):
            var = Scope({'n':n, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['newRight', 'newLeft', 'pvd', 'd', 'n', 'v', 'p'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
                var.put('v', var.get('n').get('key'))
                var.put('d', var.get('n').get('value'))
        ...
        def PyJsHoisted_partitionSharedU_(n, p, this, arguments, var=var):
            var = Scope({'n':n, 'p':p, 'this':this, 'arguments':arguments}, var)
            var.registers(['key', 'match$1', 'lt', 'pvd', 'match', 'rt', 'n', 'value', 'rf', 'lf', 'p'])
            if PyJsStrictNeq(var.get('n'),var.get(u"null")):
                var.put('key', var.get('n').get('key'))
                var.put('value', var.get('n').get('value'))
                var.put('match', var.get('partitionSharedU')(var.get('n').get('left'), var.get('p')))
        ...
        def PyJsHoisted_toListAux_(_n, _accu, this, arguments, var=var):
            var = Scope({'_n':_n, '_accu':_accu, 'this':this, 'arguments':arguments}, var)
            var.registers(['_n', '_accu', 'accu', 'n', 'v', 'k', 'r', 'l'])
            while Js(True):
                var.put('accu', var.get('_accu'))
                var.put('n', var.get('_n'))
                if PyJsStrictNeq(var.get('n'),var.get(u"null")):
        ...
        def PyJsHoisted_fillArrayValue_(_n, _i, arr, this, arguments, var=var):
            var = Scope({'_n':_n, '_i':_i, 'arr':arr, 'this':this, 'arguments':arguments}, var)
            var.registers(['_n', 'rnext', '_i', 'n', 'i', 'r', 'l', 'arr', 'next'])
            while Js(True):
                var.put('i', var.get('_i'))
                var.put('n', var.get('_n'))
                var.put('l', var.get('n').get('left'))
        ...
        def PyJsHoisted_fromSortedArrayRevAux_(arr, off, len, this, arguments, var=var):
            var = Scope({'arr':arr, 'off':off, 'len':len, 'this':this, 'arguments':arguments}, var)
            var.registers(['match_001$1', 'match$1', 'match_000$1', 'match$5', 'match$4', 'off', 'match$2', 'match$6', 'right', 'match', 'left', 'len', 'match_000', 'match_002', 'nl', 'match$3', 'arr', 'match_001'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('len'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(0.0)):
        ...
        def PyJsHoisted_cmpU_(s1, s2, kcmp, vcmp, this, arguments, var=var):
            ...
            var.registers(['s1', 'cx', '_e1', 'h1', 'h2', 'c', 's2', 'len2', '_e2', 'e2', 'e1', 'kcmp', 'kcmp$1', 'vcmp$1', 'vcmp', 'len1'])
            var.put('len1', var.get('size')(var.get('s1')))
            var.put('len2', var.get('size')(var.get('s2')))
            if PyJsStrictEq(var.get('len1'),var.get('len2')):
                var.put('_e1', var.get('stackAllLeft')(var.get('s1'), Js(0.0)))
        ...
        def PyJsHoisted_eqU_(s1, s2, kcmp, veq, this, arguments, var=var):
            ...
            var.registers(['s1', 'veq', '_e1', 'e1', 'h2', 'h1', 's2', 'len2', '_e2', 'veq$1', 'e2', 'kcmp', 'kcmp$1', 'len1'])
            var.put('len1', var.get('size')(var.get('s1')))
            var.put('len2', var.get('size')(var.get('s2')))
            if PyJsStrictEq(var.get('len1'),var.get('len2')):
                var.put('_e1', var.get('stackAllLeft')(var.get('s1'), Js(0.0)))
        ...
        def PyJsHoisted_getWithDefault_(_n, x, PyJsArg_646566_, cmp, this, arguments, var=var):
            ...
            var.registers(['_n', 'def', 'cmp', 'c', 'n', 'x', 'v'])
            while Js(True):
                var.put('n', var.get('_n'))
                if PyJsStrictNeq(var.get('n'),var.get(u"null")):
                    var.put('v', var.get('n').get('key'))
        ...
        def PyJsHoisted_updateMutate_(t, x, data, cmp, this, arguments, var=var):
            ...
            var.registers(['ll', 'cmp', 'c', 'k', 'r', 'data', 'x', 'l', 't'])
            if PyJsStrictNeq(var.get('t'),var.get(u"null")):
                var.put('k', var.get('t').get('key'))
                var.put('c', var.get('cmp')(var.get('x'), var.get('k')))
                if PyJsStrictEq(var.get('c'),Js(0.0)):
        ...
        def PyJsHoisted_fromArray_(xs, cmp, this, arguments, var=var):
            var = Scope({'xs':xs, 'cmp':cmp, 'this':this, 'arguments':arguments}, var)
            var.registers(['result', 'i_finish', 'match', 'i', 'len', 'cmp', 'xs', 'next'])
            var.put('len', var.get('xs').get('length'))
            if PyJsStrictEq(var.get('len'),Js(0.0)):
                return var.get(u"null")
            else:
    ...
    def PyJs_anonymous_16_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['Caml_bytes', 'rindex_opt', 'make', 'index_from', 'to_string', 'rindex', 'module', 'apply1', 'lowercase', 'rindex_from_opt', 'iteri', 'escaped', 'uncapitalize', 'unsafe_to_string', 'sub', 'capitalize_ascii', 'of_string', 'mapi', 'lowercase_ascii', 'Caml_builtin_exceptions', 'index_opt', 'ensure_ge', 'contains_from', 'contains', 'uncapitalize_ascii', 'Char', 'index_from_opt', 'unsafe_of_string', '$plus$plus', 'compare', 'rindex_from', 'uppercase_ascii', 'blit', 'map', 'Caml_primitive', 'empty', 'extend', 'concat', 'index', 'index_rec_opt', 'sub_string', 'uppercase', 'require', 'exports', 'sum_lengths', 'fill', 'rindex_rec_opt', 'init', 'equal', 'blit_string', 'copy', 'iter', 'Curry', 'trim', 'is_space', 'index_rec', 'cat', 'rcontains_from', 'capitalize', 'rindex_rec'])
        @Js
        ...
        def PyJsHoisted_init_(n, f, this, arguments, var=var):
            var = Scope({'n':n, 'f':f, 'this':this, 'arguments':arguments}, var)
            var.registers(['s', 'i_finish', 'n', 'i', 'f'])
            var.put('s', var.get('Caml_bytes').callprop('caml_create_bytes', var.get('n')))
            #for JS loop
            var.put('i', Js(0.0))
        ...
        def PyJsHoistedNonPyName(a, b, this, arguments, var=var):
            ...
            var.registers(['match$1', 'match$2', 'a', 'match', 'c', 'b'])
        ...
        def PyJsHoisted_extend_(s, left, right, this, arguments, var=var):
            ...
            var.registers(['s', 'srcoff', 'right', 'match', 'cpylen', 'left', 'len', 'dstoff', 'r'])
        ...
        def PyJsHoisted_blit_(s1, ofs1, s2, ofs2, len, this, arguments, var=var):
            ...
            var.registers(['s1', 'ofs2', 'ofs1', 'len', 's2'])
        ...
        def PyJsHoisted_sum_lengths_(_acc, seplen, _param, this, arguments, var=var):
            ...
            var.registers(['_param', '_acc', 'acc', 'seplen', 'hd', 'tl', 'param'])
            while Js(True):
        ...
        def PyJsHoisted_concat_(sep, l, this, arguments, var=var):
            ...
            var.registers(['seplen$1', 'dst', '_param', 'seplen', 'hd', 'tl', 'sep', 'pos', 'param', 'l', 'sep$1', '_pos'])
            if var.get('l'):
        ...
        def PyJsHoisted_escaped_(s, this, arguments, var=var):
            var = Scope({'s':s, 'this':this, 'arguments':arguments}, var)
            var.registers(['tmp', 's', 'i_finish', 'match', 'switcher', 's$prime', 'n', 'i', 'c', 'exit', 'i$1', 'i_finish$1'])
            var.put('n', Js(0.0))
            #for JS loop
            var.put('i', Js(0.0))
        ...
        def PyJsHoisted_map_(f, s, this, arguments, var=var):
            ...
            var.registers(['s', 'i_finish', 'i', 'f', 'r', 'l'])
        ...
        def PyJsHoisted_contains_from_(s, i, c, this, arguments, var=var):
            ...
            try:
                ...
                PyJsHolder_65786e_84658442 = var.own.get('exn')
                ...
                try:
                    ...
                    if PyJsHolder_65786e_84658442 is not None:
                        var.own['exn'] = PyJsHolder_65786e_84658442
                    else:
                        del var.own['exn']
                    del PyJsHolder_65786e_84658442
        ...
        def PyJsHoisted_rcontains_from_(s, i, c, this, arguments, var=var):
            ...
            try:
                ...
                PyJsHolder_65786e_34907271 = var.own.get('exn')
                var.force_own_put('exn', PyExceptionToJs(PyJsTempException))
                try:
                    if PyJsStrictEq(var.get('exn'),var.get('Caml_builtin_exceptions').get('not_found')):
                        return Js(False)
                    ...
                    if PyJsHolder_65786e_34907271 is not None:
                        var.own['exn'] = PyJsHolder_65786e_34907271
                    else:
                        del var.own['exn']
                    del PyJsHolder_65786e_34907271
    ...
    def PyJs_anonymous_17_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['fill', 'caml_array_concat', 'caml_array_get', 'require', 'module', 'caml_array_set', 'Caml_builtin_exceptions', 'caml_make_float_vect', 'len', 'caml_array_dup', 'caml_array_sub', 'caml_array_blit', 'exports', 'caml_make_vect'])
        @Js
        def PyJsHoisted_caml_array_sub_(x, offset, len, this, arguments, var=var):
            ...
            var.registers(['result', 'i', 'len', 'j', 'x', 'offset'])
            var.put('result', var.get('Array').create(var.get('len')))
            var.put('j', Js(0.0))
        ...
        def PyJsHoisted_fill_(arr, _i, _l, this, arguments, var=var):
            ...
            var.registers(['arr', '_i', 'i', 'k', 'j', 'x', 'l', 'l$1', '_l'])
            while Js(True):
                var.put('l', var.get('_l'))
                var.put('i', var.get('_i'))
                if var.get('l'):
        ...
        def PyJsHoisted_caml_make_vect_(len, init, this, arguments, var=var):
            ...
            var.registers(['init', 'i_finish', 'len', 'i', 'b'])
        ...
        def PyJsHoisted_caml_make_float_vect_(len, this, arguments, var=var):
            ...
            var.registers(['i_finish', 'b', 'len', 'i'])
            var.put('b', var.get('Array').create(var.get('len')))
            #for JS loop
            var.put('i', Js(0.0))
            var.put('i_finish', ((var.get('len')-Js(1.0))|Js(0.0)))
        ...
        def PyJsHoisted_caml_array_blit_(a1, i1, a2, i2, len, this, arguments, var=var):
            ...
            var.registers(['a2', 'j$1', 'i2', 'a1', 'len', 'i1', 'j_finish', 'j'])
    ...
    def PyJs_anonymous_18_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['end_of_file', 'require', 'assert_failure', 'sys_error', 'module', 'stack_overflow', 'out_of_memory', 'division_by_zero', 'invalid_argument', 'failure', 'undefined_recursive_module', 'sys_blocked_io', 'exports', 'match_failure', 'not_found'])
        Js('use strict')
    ...
    def PyJs_anonymous_19_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['caml_blit_bytes', 'module', 'caml_blit_string', 'Caml_builtin_exceptions', 'caml_create_bytes', 'bytes_of_string', 'get', 'bytes_to_string', 'caml_fill_bytes', 'exports', 'require'])
        @Js
        ...
        def PyJsHoisted_caml_fill_bytes_(s, i, l, c, this, arguments, var=var):
            ...
            var.registers(['s', 'c', 'i', 'k', 'k_finish', 'l'])
            if (var.get('l')>Js(0.0)):
                #for JS loop
                var.put('k', var.get('i'))
        ...
        def PyJsHoisted_caml_create_bytes_(len, this, arguments, var=var):
            var = Scope({'len':len, 'this':this, 'arguments':arguments}, var)
            var.registers(['i_finish', 'result', 'len', 'i'])
            if (var.get('len')<Js(0.0)):
        ...
        def PyJsHoisted_caml_blit_bytes_(s1, i1, s2, i2, len, this, arguments, var=var):
            ...
            var.registers(['i_finish', 's2', 'k', 'range_a$1', 's1$1', 'i_finish$2', 'range_a', 'len$1', 'i2', 'i', 'len', 'i$1', 'i_finish$1', 'i$2', 'range$1', 'range_b$1', 'off1', 's1', 'i2$1', 'range_b', 'i1$1', 'range', 'i1', 'j'])
            if (var.get('len')>Js(0.0)):
        ...
        def PyJsHoisted_bytes_to_string_(a, this, arguments, var=var):
            var = Scope({'a':a, 'this':this, 'arguments':arguments}, var)
            var.registers(['s', 'bytes', 'a', 'len', 'i', 's_len', 'tmp_bytes', 'offset', 'next'])
        ...
        def PyJsHoisted_caml_blit_string_(s1, i1, s2, i2, len, this, arguments, var=var):
            var = Scope({'s1':s1, 'i1':i1, 's2':s2, 'i2':i2, 'len':len, 'this':this, 'arguments':arguments}, var)
            var.registers(['off1', 's1', 'i_finish', 'i2', 'i', 's2', 'i1', 'len', 'i_finish$2', 'i$1', 'i_finish$1', 'i$2'])
            if (var.get('len')>Js(0.0)):
                var.put('off1', ((var.get('s1').get('length')-var.get('i1'))|Js(0.0)))
                if (var.get('len')<=var.get('off1')):
                    #for JS loop
        ...
        def PyJsHoisted_bytes_of_string_(s, this, arguments, var=var):
            var = Scope({'s':s, 'this':this, 'arguments':arguments}, var)
            var.registers(['s', 'i_finish', 'i', 'len', 'res'])
            var.put('len', var.get('s').get('length'))
    ...
    def PyJs_anonymous_20_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['caml_max', 'module', 'caml_update_dummy', 'for_in', 'caml_lessthan', 'caml_equal_null', 'caml_lazy_make', 'caml_obj_truncate', 'caml_obj_dup', 'caml_min', 'caml_obj_block', 'Block', 'Caml_builtin_exceptions', 'caml_lazy_make_forward', 'caml_obj_set_tag', 'caml_equal_nullable', 'caml_equal', 'caml_greaterthan', 'caml_notequal', 'Caml_primitive', 'caml_lessequal', 'caml_greaterequal', 'exports', 'require', 'caml_equal_undefined', 'caml_compare'])
        @Js
        ...
        def PyJsHoisted_caml_obj_dup_(x, this, arguments, var=var):
            var = Scope({'x':x, 'this':this, 'arguments':arguments}, var)
            var.registers(['i_finish', 'i', 'len', 'x', 'v'])
        ...
        def PyJsHoisted_caml_obj_truncate_(x, new_size, this, arguments, var=var):
            ...
            var.registers(['i_finish', 'new_size', 'i', 'len', 'x'])
            var.put('len', (var.get('x').get('length')|Js(0.0)))
        ...
        def PyJsHoisted_caml_compare_(_a, _b, this, arguments, var=var):
            ...
            var.registers(['b$1', '_i', 'a', '_a', 'len_a', 'min_key_rhs', 'tag_a', 'b$4', 'b', 'short_length', 'partial_arg', 'res$1', 'short_length$1', 'match$1', '_i$2', 'min_key_lhs', 'a$1', 'partial_arg$1', 'do_key_a', 'match', 'a$4', 'res$2', 'i', 'do_key_b', 'i$1', 'same_length', 'do_key', 'a_type', 'i$2', 'b$2', 'a$2', 'b$3', 'len_b', '_b', 'a$3', 'tag_b', '_i$1', 'res', 'b_type'])
            while Js(True):
                                                                                    ...
                                                                                    if var.get('Array').callprop('isArray', var.get('a')):
                                                                                        ...
                                                                                        if (var.get('a').instanceof(var.get('Date')) and var.get('b').instanceof(var.get('Date'))):
                                                                                            ...
                                                                                            def PyJs_anonymous_23_(param, key, this, arguments, var=var):
                                                                                                ...
                                                                                                var.registers(['key', 'match', 'param', 'min_key', 'b'])
        ...
        def PyJsHoisted_caml_equal_(_a, _b, this, arguments, var=var):
            var = Scope({'_a':_a, '_b':_b, 'this':this, 'arguments':arguments}, var)
            var.registers(['b$1', '_i', 'a', '_a', 'len_a', 'tag_a', 'b', 'a$1', 'do_key_a', 'i', 'do_key_b', 'same_length', 'a_type', 'b$2', 'a$2', 'result', 'len_b', '_b', 'tag_b', 'b_type'])
            while Js(True):
                var.put('b', var.get('_b'))
                var.put('a', var.get('_a'))
                if PyJsStrictEq(var.get('a'),var.get('b')):
    ...
    def PyJs_anonymous_32_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['undefined_to_opt', 'module', 'nullable_to_opt', 'exports', 'undefinedHeader', 'valFromOption', 'option_get_unwrap', 'null_to_opt', 'option_get', 'some', 'require'])
        @Js
        def PyJsHoisted_some_(x, this, arguments, var=var):
            var = Scope({'x':x, 'this':this, 'arguments':arguments}, var)
            var.registers(['block$1', 'x', 'block', 'nid'])
    ...
    def PyJs_anonymous_33_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['caml_bytes_equal', 'caml_string_min', 'module', 'caml_nativeint_min', 'caml_nativeint_compare', 'caml_int32_compare', 'caml_float_min', 'caml_int32_min', 'caml_bytes_compare_aux', 'caml_float_compare', 'caml_bool_max', 'caml_int_compare', 'caml_float_max', 'caml_bytes_compare', 'caml_bool_min', 'caml_string_max', 'caml_int_max', 'exports', 'require', 'caml_string_compare', 'caml_int32_max', 'caml_nativeint_max', 'caml_bool_compare', 'caml_int_min'])
        @Js
        ...
        def PyJsHoisted_caml_bytes_compare_aux_(s1, s2, _off, len, PyJsArg_646566_, this, arguments, var=var):
            ...
            var.registers(['def', '_off', 's1', 'a', 'len', 's2', 'b', 'off'])
            while Js(True):
        ...
        def PyJsHoisted_caml_bytes_equal_(s1, s2, this, arguments, var=var):
            var = Scope({'s1':s1, 's2':s2, 'this':this, 'arguments':arguments}, var)
            var.registers(['_off', 's1', 'a', 'len', 's1$1', 's2$1', 'len2', 's2', 'b', 'off', 'len1'])
            var.put('len1', var.get('s1').get('length'))
            var.put('len2', var.get('s2').get('length'))
            if PyJsStrictEq(var.get('len1'),var.get('len2')):
                var.put('s1$1', var.get('s1'))
    ...
    def PyJs_anonymous_34_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['Caml_bytes', 'compare', 'module', 'lowercase_ascii', 'equal', 'uppercase_ascii', 'Caml_builtin_exceptions', 'exports', 'lowercase', 'chr', 'escaped', 'uppercase', 'require'])
        @Js
    ...
    def PyJs_anonymous_35_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['curry_4', '_1', 'module', 'app', '__3', 'curry_1', 'curry_5', '_5', 'curry_6', 'curry_2', '_6', 'curry_8', 'curry_7', 'curry_3', '__5', '_3', '__2', '__6', 'Caml_array', '_2', '__4', '__8', '__1', '_8', 'exports', 'require', '_7', '_4', '__7'])
        @Js
        def PyJsHoisted_app_(_f, _args, this, arguments, var=var):
            var = Scope({'_f':_f, '_args':_args, 'this':this, 'arguments':arguments}, var)
            var.registers(['args', '_args', 'd', 'len', 'init_arity', 'f', '_f', 'arity'])
            while Js(True):
            ...
            while 1:
                ...
                if SWITCHED or PyJsStrictEq(CONDITION, Js(4.0)):
                    ...
                    def PyJs_anonymous_40_(param, PyJsArg_706172616d2431_, PyJsArg_706172616d2432_, this, arguments, var=var):
                        ...
                        var.registers(['param$2', 'param$1', 'param'])
                ...
                if SWITCHED or PyJsStrictEq(CONDITION, Js(5.0)):
                    ...
                    def PyJs_anonymous_41_(param, PyJsArg_706172616d2431_, PyJsArg_706172616d2432_, PyJsArg_706172616d2433_, this, arguments, var=var):
                        ...
                        var.registers(['param$2', 'param$1', 'param$3', 'param'])
                ...
                if SWITCHED or PyJsStrictEq(CONDITION, Js(6.0)):
                    ...
                    def PyJs_anonymous_42_(param, PyJsArg_706172616d2431_, PyJsArg_706172616d2432_, PyJsArg_706172616d2433_, PyJsArg_706172616d2434_, this, arguments, var=var):
                        ...
                        var.registers(['param$3', 'param$4', 'param$2', 'param$1', 'param'])
                ...
                if SWITCHED or PyJsStrictEq(CONDITION, Js(7.0)):
                    ...
                    def PyJs_anonymous_43_(param, PyJsArg_706172616d2431_, PyJsArg_706172616d2432_, PyJsArg_706172616d2433_, PyJsArg_706172616d2434_, PyJsArg_706172616d2435_, this, arguments, var=var):
                        ...
                        var.registers(['param$5', 'param$3', 'param$4', 'param$2', 'param$1', 'param'])
        ...
        def PyJsHoisted_curry_3_(o, a0, a1, a2, arity, this, arguments, var=var):
            ...
            var.registers(['a2', 'a0', 'a1', 'o', 'arity'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('arity'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(1.0)):
        ...
        def PyJsHoisted_curry_4_(o, a0, a1, a2, a3, arity, this, arguments, var=var):
            ...
            var.registers(['a2', 'a0', 'a1', 'a3', 'o', 'arity'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('arity'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(1.0)):
        ...
        def PyJsHoisted_curry_5_(o, a0, a1, a2, a3, a4, arity, this, arguments, var=var):
            ...
            var.registers(['a2', 'a0', 'a1', 'a4', 'a3', 'o', 'arity'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('arity'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(1.0)):
        ...
        def PyJsHoisted_curry_6_(o, a0, a1, a2, a3, a4, a5, arity, this, arguments, var=var):
            ...
            var.registers(['a2', 'a0', 'a1', 'a5', 'a4', 'a3', 'o', 'arity'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('arity'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(1.0)):
        ...
        def PyJsHoisted___6_(o, this, arguments, var=var):
            ...
            if PyJsStrictEq(var.get('arity'),Js(6.0)):
                ...
                def PyJs_anonymous_64_(a0, a1, a2, a3, a4, a5, this, arguments, var=var):
                    ...
                    var.registers(['a2', 'a0', 'a1', 'a5', 'a4', 'a3'])
        ...
        def PyJsHoisted_curry_7_(o, a0, a1, a2, a3, a4, a5, a6, arity, this, arguments, var=var):
            ...
            var.registers(['a2', 'a0', 'a6', 'a1', 'a5', 'a4', 'a3', 'o', 'arity'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('arity'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(1.0)):
        ...
        def PyJsHoisted___7_(o, this, arguments, var=var):
            ...
            if PyJsStrictEq(var.get('arity'),Js(7.0)):
                ...
                def PyJs_anonymous_65_(a0, a1, a2, a3, a4, a5, a6, this, arguments, var=var):
                    ...
                    var.registers(['a2', 'a0', 'a6', 'a1', 'a5', 'a4', 'a3'])
        ...
        def PyJsHoisted_curry_8_(o, a0, a1, a2, a3, a4, a5, a6, a7, arity, this, arguments, var=var):
            ...
            var.registers(['a2', 'a7', 'a0', 'a6', 'a1', 'a5', 'a4', 'a3', 'o', 'arity'])
            while 1:
                SWITCHED = False
                CONDITION = (var.get('arity'))
                if SWITCHED or PyJsStrictEq(CONDITION, Js(1.0)):
        ...
        def PyJsHoisted___8_(o, this, arguments, var=var):
            ...
            if PyJsStrictEq(var.get('arity'),Js(8.0)):
                ...
                def PyJs_anonymous_66_(a0, a1, a2, a3, a4, a5, a6, a7, this, arguments, var=var):
                    ...
                    var.registers(['a2', 'a7', 'a0', 'a6', 'a1', 'a5', 'a4', 'a3'])
    ...
    def PyJs_anonymous_67_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['module', 'equal', 'max', 'min', 'exports', 'require'])
        @Js
    ...
    def PyJs_anonymous_68_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['Js_int', 'module', 'ceil_int', 'unsafe_ceil', 'floor_int', 'ceil', 'random_int', 'exports', 'require', 'floor', 'unsafe_floor'])
        @Js
    ...
    def PyJs_anonymous_69_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['Caml_bytes', 'rindex_opt', 'make', 'index_from', 'module', 'rindex', 'lowercase', 'rindex_from_opt', 'iteri', 'escaped', 'uncapitalize', 'sub', 'capitalize_ascii', 'mapi', 'lowercase_ascii', 'Caml_builtin_exceptions', 'index_opt', 'ensure_ge', 'contains_from', 'contains', 'uncapitalize_ascii', 'index_from_opt', 'compare', 'rindex_from', 'uppercase_ascii', 'blit', 'map', 'Caml_primitive', 'split_on_char', 'concat', 'index', 'index_rec_opt', 'uppercase', 'Bytes', 'require', 'sum_lengths', 'fill', 'rindex_rec_opt', 'init', 'exports', 'equal', 'copy', 'iter', 'Curry', 'trim', 'unsafe_blits', 'is_space', 'index_rec', 'rcontains_from', 'capitalize', 'rindex_rec'])
        @Js
        def PyJsHoisted_make_(n, c, this, arguments, var=var):
            var = Scope({'n':n, 'c':c, 'this':this, 'arguments':arguments}, var)
            var.registers(['c', 'n'])
        ...
        def PyJsHoisted_unsafe_blits_(dst, _pos, sep, seplen, _param, this, arguments, var=var):
            ...
            var.registers(['dst', '_param', 'seplen', 'hd', 'tl', 'sep', 'pos', 'param', '_pos'])
            while Js(True):
                var.put('param', var.get('_param'))
                var.put('pos', var.get('_pos'))
                if var.get('param'):
        ...
        def PyJsHoisted_escaped_(s, this, arguments, var=var):
            ...
            def PyJs_anonymous_70_(_i, this, arguments, var=var):
                ...
                var.registers(['_i', 'match', 'switcher', 'i'])
                while Js(True):
                    var.put('i', var.get('_i'))
        ...
        def PyJsHoisted_contains_from_(s, i, c, this, arguments, var=var):
            ...
            try:
                ...
                PyJsHolder_65786e_64036080 = var.own.get('exn')
                var.force_own_put('exn', PyExceptionToJs(PyJsTempException))
                try:
                    if PyJsStrictEq(var.get('exn'),var.get('Caml_builtin_exceptions').get('not_found')):
                        return Js(False)
                    ...
                    if PyJsHolder_65786e_64036080 is not None:
                        var.own['exn'] = PyJsHolder_65786e_64036080
                    else:
                        del var.own['exn']
                    del PyJsHolder_65786e_64036080
        PyJsHoisted_contains_from_.func_name = 'contains_from'
        var.put('contains_from', PyJsHoisted_contains_from_)
        @Js
        def PyJsHoisted_contains_(s, c, this, arguments, var=var):
        ...
        def PyJsHoisted_rcontains_from_(s, i, c, this, arguments, var=var):
            ...
            try:
                ...
                PyJsHolder_65786e_7574860 = var.own.get('exn')
                var.force_own_put('exn', PyExceptionToJs(PyJsTempException))
                try:
                    if PyJsStrictEq(var.get('exn'),var.get('Caml_builtin_exceptions').get('not_found')):
                        return Js(False)
                    ...
                    if PyJsHolder_65786e_7574860 is not None:
                        var.own['exn'] = PyJsHolder_65786e_7574860
                    else:
                        del var.own['exn']
                    del PyJsHolder_65786e_7574860
        PyJsHoisted_rcontains_from_.func_name = 'rcontains_from'
        var.put('rcontains_from', PyJsHoisted_rcontains_from_)
        @Js
        def PyJsHoisted_uppercase_ascii_(s, this, arguments, var=var):
    ...
    def PyJs_anonymous_71_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['make', 'module', 'create', 'convertChildToFocus', '$$Set$2', 'fromArray', 'convertChildToParent', 'make$3', '$$Set$1', 'convertParentToChild', 'make$2', 'Comparable$2', '$$Map$2', 'toString', 'create$2', 'convertFocusToParent', 'cmp', 'FocusId', 'make$1', 'cmp$1', 'fromArray$1', 'make$4', 'convertFocusToChild', 'toString$2', 'make$5', 'Id$2', 'Caml_obj', 'ChildId', 'Id', 'toString$1', 'Make', 'Belt_Map', 'Comparable', '$$Set', 'Comparable$1', 'ParentId', 'exports', 'require', 'create$1', 'fromArray$2', 'convertParentToFocus', 'Belt_Id', 'cmp$2', 'Belt_Set', '$$Map', '$$Map$1', 'Id$1'])
        @Js
        def PyJsHoisted_Make_(PyJsArg_2473746172_, this, arguments, var=var):
            ...
            var.registers(['make', 'create', '$star', 'Id', 'fromArray', 'Comparable', 'toString', '$$Set', '$$Map', 'cmp', 'make$1'])
            @Js
    ...
    def PyJs_anonymous_77_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['module', 'T', 'Path_immutable$KaroshibeeReTree', 'PID', 'exports', 'require'])
        Js('use strict')
    ...
    def PyJs_anonymous_78_(require, module, exports, this, arguments, var=var):
        var = Scope({'require':require, 'module':module, 'exports':exports, 'this':this, 'arguments':arguments}, var)
        var.registers(['module', 'fromRootToPathList', 'fromList', 'Belt_Option', 'PID', 'Belt_List', 'fromPathToRootList', 'Caml_option', 'Identity$KaroshibeeReTree', 'pathFromRoot', 'append', 'root', 'toString', '$$String', 'Caml_obj', 'removeElement', 'empty', 'moveDown', 'moveUp', 'concat', 'exports', 'require', 'pathToRoot', 'size', 'eq', 'parent'])
        @Js
